...
════════════════════════════════════════════════════════ */
const PROJECTS = [
  { emoji:'🎨', image:'/portfolio-preview.png', title:'Portfolio Website',   desc:'A responsive personal portfolio showcasing my work and skills using modern web technologies.',             tags:['HTML','CSS','JavaScript','React','Nodejs','MongoDB'],     btn1:{label:'Live Demo',    href:'#'}, btn2:{label:'GitHub',     href:'#'} },
//   { emoji:'📱', image:'\mobile-app-ui.png', title:'Mobile App UI',       desc:'Designed a clean and intuitive mobile app interface focusing on user experience and accessibility.',        tags:['Figma','UI/UX','Design'],       btn1:{label:'View Design', href:'#'}, btn2:{label:'Case Study', href:'#'} },
//   { emoji:'🤖', image:'\ai-chatbot.png', title:'AI Chatbot',          desc:'Built an intelligent chatbot using Python and natural language processing for customer support.',           tags:['Python','NLP','AI'],            btn1:{label:'Try It',      href:'#'}, btn2:{label:'GitHub',     href:'#'} },
      ...
      <div className="contact-main-grid" style={{ display:'grid', gridTemplateColumns:'1.6fr 1fr', gap:'clamp(1.5rem,3vw,2.5rem)', maxWidth:'1000px', margin:'0 auto' }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:'clamp(1rem,2vw,1.5rem)', animation:visible?'fadeInRight 0.8s ease 0.5s both':'none', opacity:visible?undefined:0 }}>
          ...
          <div style={{ background:isLight?'#fff':'#0a0a0a', borderRadius:'14px', padding:'clamp(1rem,2.5vw,1.5rem)', border:'1px solid rgba(255,90,0,0.15)', boxShadow:isLight?'0 4px 18px rgba(0,0,0,0.08)':'none' }}>
            ...
            {[{ch:'📧',label:'Email',val:'< 24 hours'},{ch:'📱',label:'WhatsApp',val:'< 2 hours'},{ch:'💼',label:'LinkedIn',val:'< 48 hours'}].map(r=>(
