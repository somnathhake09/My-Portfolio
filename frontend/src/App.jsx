...
function BgAnimation({ isLight }) {
  ...
  return (
    ...
    >
      {[
        { w: 320, h: 320, top: "8%", left: "8%", d: "0s" },
        { w: 420, h: 420, top: "58%", right: "6%", d: "3s" },
        { w: 260, h: 260, bottom: "8%", left: "48%", d: "6s" },
      ].map((c, i) => (
        <div
          key={i}
          style={{
            ...
            height: c.h,
            borderRadius: "50%",
            background: `radial-gradient(circle,rgba(255,90,0,${a}) 0%,transparent 70%)`,
            top: c.top,
            left: c.left,
            right: c.right,
            bottom: c.bottom,
      ...
      {["18%", "48%", "78%"].map((top, i) => (
        <div
          ...
          style={{
            ...
            width: "100%",
            top,
            background: `linear-gradient(90deg,transparent,${isLight ? "#ff4000" : "#ff5a00"},transparent)`,
      ...
      {[
        { top: "28%", right: "18%", d: "0s" },
        { bottom: "38%", left: "12%", d: "4s" },
      ].map((o, i) => (
        <div
          key={i}
          style={{
            ...
            height: 160,
            borderRadius: "50%",
            background: `radial-gradient(circle,rgba(255,90,0,${isLight ? "0.18" : "0.38"}) 0%,transparent 70%)`,
            filter: "blur(45px)",
            top: o.top,
            right: o.right,
            bottom: o.bottom,
  ...
  return (
    <button
      ...
      style={{
        ...
        flexShrink: 0,
        boxShadow: hov
          ? "0 6px 24px rgba(255,90,0,0.6)"
          : "0 3px 14px rgba(255,90,0,0.3)",
        transform: hov ? "rotate(180deg) scale(1.1)" : "none",
      }}
    ...
    <>
      <nav
        style={{
          ...
          right: 0,
          zIndex: 1000,
          padding: "clamp(0.9rem,2vw,1.5rem) clamp(1rem,5vw,5%)",
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      height: "2px",
                      borderRadius: "2px",
                      background: "linear-gradient(90deg,#ff5a00,#ff8800)",
                      width: hov === i || active ? "100%" : "0%",
      ...
      {open && (
        <div
          ...
          style={{
            ...
            right: 0,
            zIndex: 999,
            background: isLight ? "rgba(245,245,245,0.97)" : "rgba(8,8,8,0.97)",
              ...
              style={{
                ...
                borderBottom:
                  i < NAV_ITEMS.length - 1
                    ? `1px solid rgba(255,90,0,${isLight ? "0.09" : "0.11"})`
                    : "none",
                transition: "all 0.2s",
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.color = "#ff5a00";
                e.currentTarget.style.paddingLeft = "clamp(1.4rem,6vw,2.5rem)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.paddingLeft = "clamp(1rem,5vw,2rem)";
              }}
            >
              <span
                style={{
...
function useTyping(texts, speed = 100, del = 50, pause = 2000) {
  ...
  useEffect(() => {
    const cur = texts[idx];
    let t;
    if (!isDel && ci < cur.length)
      t = setTimeout(() => {
        setDisp(cur.slice(0, ci + 1));
        setCi((c) => c + 1);
      }, speed);
    else if (!isDel && ci === cur.length)
...
function HomeSection({ isLight }) {
  ...
  useEffect(() => {
    ...
    if (!hero) return;
    const defs = [
      { char: "{", top: "12%", left: "5%", delay: "0s" },
      { char: "}", top: "12%", right: "5%", delay: "1.5s" },
      { char: "<", bottom: "14%", left: "8%", delay: "0.7s" },
      { char: ">", bottom: "14%", right: "8%", delay: "2.2s" },
    ];
  ...
  useEffect(() => {
    ...
    const add = () => {
      ...
      Object.assign(div.style, {
        ...
        color: isLight ? "rgba(255,64,0,0.25)" : "rgba(255,90,0,0.25)",
        pointerEvents: "none",
        userSelect: "none",
        left: Math.random() * 88 + "%",
        top: Math.random() * 85 + "%",
        animationName: "symbolDrift",
        animationDuration: Math.random() * 10 + 12 + "s",
        animationDelay: Math.random() * 2 + "s",
        animationTimingFunction: "ease-in-out",
      });
    ...
    const id = setInterval(add, 2200);
    for (let i = 0; i < 10; i++) setTimeout(add, i * 400);
    return () => {
      clearInterval(id);
  ...
  return (
    <section
      ...
      style={{
        ...
        justifyContent: "center",
        padding:
          "clamp(5rem,12vw,9rem) clamp(1rem,6vw,5%) clamp(2rem,5vw,4rem)",
    ...
    >
      <div
        ...
        style={{
          ...
          color: `rgba(255,90,0,${isLight ? "0.025" : "0.04"})`,
          lineHeight: 1.6,
          overflow: "hidden",
          whiteSpace: "pre",
        }}
      ...
      <div
        ...
        style={{
          ...
          background:
            "radial-gradient(circle,rgba(255,90,0,0.1) 0%,transparent 70%)",
          borderRadius: "50%",
          top: "-26%",
          right: "-20%",
      ...
      <div
        ...
        style={{
          ...
          background:
            "radial-gradient(circle,rgba(255,90,0,0.07) 0%,transparent 70%)",
          borderRadius: "50%",
          bottom: "-20%",
          left: "-18%",
      ...
      >
        ...
        <h1
          style={{
            ...
            fontWeight: 800,
            lineHeight: 1.1,
            marginBottom: "clamp(0.8rem,2.5vw,1.3rem)",
            background:
              "linear-gradient(135deg,#ff5a00 0%,#ff8800 55%,#ffaa00 100%)",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent",
            backgroundClip: "text",
        ...
        <p
          style={{
            ...
            marginBottom: "clamp(1.8rem,4vw,2.6rem)",
        ...
        >
          ...
          <span
            style={{
              ...
              color: "#ff5a00",
              borderRight: "2.5px solid #ff5a00",
              paddingRight: "3px",
        ...
        >
          ...
          <div
            style={{
              width: "20px",
              height: "34px",
              border: `2px solid ${isLight ? "rgba(0,0,0,0.18)" : "rgba(255,255,255,0.15)"}`,
              borderRadius: "12px",
              display: "flex",
              justifyContent: "center",
              paddingTop: "6px",
    ...
    <a
      ...
      style={{
        ...
        ...(primary
          ? {
              background: hov
                ? "linear-gradient(135deg,#ff3a00,#ff6a00)"
                : "linear-gradient(135deg,#ff5a00,#ff7a00)",
              color: "#fff",
              boxShadow: hov
                ? "0 14px 40px rgba(255,90,0,0.65)"
                : "0 8px 25px rgba(255,90,0,0.4)",
          ...
          : {
              background: hov
                ? "linear-gradient(135deg,#ff5a00,#ff7a00)"
                : "transparent",
              color: hov ? "#fff" : "#ff5a00",
              border: "2px solid #ff5a00",
              boxShadow: hov
                ? "0 14px 40px rgba(255,90,0,0.5)"
                : "0 4px 18px rgba(255,90,0,0.15)",
              transform: hov ? "translateY(-3px)" : "none",
            }),
      }}
      onMouseEnter={() => setHov(true)}
  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${hov ? "#ff5a00" : "rgba(255,90,0,0.18)"}`,
        borderRadius: "14px",
        padding: "clamp(1rem,2.5vw,1.5rem)",
        transition: "all 0.3s ease",
        transform: hov ? "translateY(-6px)" : "none",
        boxShadow: hov
          ? "0 14px 38px rgba(255,90,0,0.28)"
          : isLight
    ...
    >
      ...
      <span
        style={{
          color: isLight ? "#555" : "#aaa",
          fontSize: "clamp(0.78rem,1.7vw,0.9rem)",
          lineHeight: 1.55,
  ...
  return (
    <section
      ...
      style={{
        minHeight: "100vh",
        padding:
          "clamp(5.5rem,13vw,9rem) clamp(1rem,5vw,5%) clamp(3rem,6vw,5rem)",
        position: "relative",
        opacity: visible ? 1 : 0,
    ...
    >
        ...
        >
          ...
          <span
            style={{
              ...
              borderRadius: "2px",
              display: "block",
              animation: visible ? "underlinePop 0.8s ease 0.4s both" : "none",
            }}
          />
        </h2>
      </div>
      ...
      >
        <div
          style={{
            animation: visible ? "fadeInLeft 0.8s ease 0.15s both" : "none",
            opacity: visible ? undefined : 0,
          }}
        >
          <div
            style={{
              ...
              animation:
                "imageFloat 6s ease-in-out infinite, pulseGlow 4s ease-in-out infinite",
              position: "relative",
              overflow: "hidden",
              cursor: "default",
            }}
          >
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(135deg,rgba(255,255,255,0.18) 0%,transparent 55%,rgba(255,255,255,0.06) 100%)",
                borderRadius: "24px",
                pointerEvents: "none",
              }}
            />
            <div
              className="image-code-hint"
              style={{
                position: "absolute",
                top: "14px",
                left: "16px",
...
/>
        ...
        <div
          style={{
            animation: visible ? "fadeInRight 0.8s ease 0.3s both" : "none",
            opacity: visible ? undefined : 0,
          }}
        >
          <p
          ...
          <h3
            style={{
              ...
              fontWeight: 700,
              lineHeight: 1.2,
              marginBottom: "clamp(0.9rem,2vw,1.3rem)",
              background: "linear-gradient(135deg,#ff5a00,#ff8800)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
              backgroundClip: "text",
          ...
          >
            I believe in the power of creativity and continuous learning to make
            a positive impact. My journey in tech has taught me that every
            challenge is an opportunity to learn something new.
          </p>
          <div
            className="info-grid-inner"
            style={{
              display: "grid",
          ...
          >
            {INFO_ITEMS.map((item) => (
              <InfoCard key={item.label} {...item} isLight={isLight} />
            ))}
          </div>
        </div>
      </div>
      ...
      >
        ...
        <span
          style={{
            ...
            color: "#ff5a00",
            animation: triggered ? "counterUp 0.5s ease 0.3s both" : "none",
      ...
      >
        <div
          style={{
            height: "100%",
            borderRadius: "10px",
            background: "linear-gradient(90deg,#ff3a00,#ff5a00,#ff8800)",
            backgroundSize: "200% 100%",
            animation: triggered
              ? `progressFill 1.4s cubic-bezier(0.4,0,0.2,1) 0.2s both, shimmer 2s linear 1.6s infinite, progressGlow 2s ease-in-out 1.6s infinite`
              : "none",
...
function SkillCard({
  ...
  const [hov, setHov] = useState(false);
  const [iconAni, setIconAni] = useState(false);
  return (
    <div
      onMouseEnter={() => {
        setHov(true);
      ...
      onMouseLeave={() => {
        setHov(false);
        setTimeout(() => setIconAni(false), 600);
      }}
      style={{
        ...
        boxShadow: hov
          ? "0 20px 55px rgba(255,90,0,0.35)"
          : isLight
    ...
    >
      {hov && (
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "linear-gradient(135deg,transparent 40%,rgba(255,90,0,0.04) 50%,transparent 60%)",
      ...
      <div
        style={{
          ...
          marginBottom: "0.9rem",
          display: "inline-block",
          animation: iconAni ? "iconBounce 0.6s ease" : "none",
        }}
      >
        {icon}
      </div>
      ...
      >
        {tags.map((t) => (
          <span
            key={t}
            style={{
              background: `rgba(255,90,0,${isLight ? "0.07" : "0.12"})`,
              color: isLight ? "#cc3a00" : "#ff7a30",
...
function SkillsSection({ isLight }) {
  ...
  const avgPct = Math.round(
    SKILLS.reduce((a, s) => a + s.pct, 0) / SKILLS.length,
  );
  ...
  return (
    <section
      ...
      style={{
        minHeight: "100vh",
        padding:
          "clamp(6rem,12vw,9rem) clamp(1rem,5vw,5%) clamp(3rem,6vw,5rem)",
        position: "relative",
        opacity: visible ? 1 : 0,
        transform: visible ? "translateY(0)" : "translateY(60px)",
        transition:
    ...
    >
      ...
      >
        ...
        >
          Technologies and tools I work with — each bar reflects hands-on
          experience.
        </p>
      </div>
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                borderRadius: "12px",
                padding: "clamp(0.6rem,1.5vw,0.9rem) clamp(1rem,2.5vw,1.5rem)",
                textAlign: "center",
                minWidth: "120px",
                boxShadow: isLight ? "0 3px 12px rgba(0,0,0,0.07)" : "none",
              }}
            >
              <div
                style={{
...
const SERVICES = [
  {
    ...
    desc: "Responsive and modern websites for personal, portfolio, and small business needs.",
    tags: ["HTML", "CSS", "JavaScript", "React"],
    color: "#ff5a00",
  },
  {
    ...
    desc: "Clean and professional portfolio websites to showcase skills, projects, and experience.",
    tags: ["React", "Responsive Design", "GitHub"],
    color: "#ff7a00",
  },
  {
    icon: "📊",
    title: "Data Analytics",
    desc: "Learning-focused data analysis and visualization using spreadsheets, SQL, and analytics tools.",
  ...
  },
  {
    icon: "🤖",
    title: "AI-Assisted Development",
    desc: "Using AI tools to speed up development, explore ideas, and build practical projects.",
    tags: ["AI Tools", "Prompting", "AI-Assisted Coding"],
    color: "#ff8800",
  },
];
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hov
          ? "0 20px 50px rgba(255,90,0,0.25)"
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "0.4rem" }}>
        {tags.map((t) => (
          <span
            key={t}
            style={{
              background: `rgba(255,90,0,${isLight ? "0.08" : "0.12"})`,
              color: isLight ? "#cc3a00" : "#ff7a30",
...
const FILTER_MAP = {
  All: () => true,
  React: (p) => p.tags.includes("React"),
  Python: (p) => p.tags.includes("Python"),
  JavaScript: (p) => p.tags.includes("JavaScript"),
    ...
    >
      {Object.keys(FILTER_MAP).map((f) => (
        <button
          ...
          onClick={() => onChange(f)}
          style={{
            padding: "0.45rem clamp(0.9rem,2vw,1.3rem)",
            borderRadius: "50px",
            border: "2px solid",
            borderColor:
              active === f
                ? "#ff5a00"
                : `rgba(255,90,0,${isLight ? "0.25" : "0.3"})`,
            background:
              active === f
                ? "linear-gradient(135deg,#ff5a00,#ff7a00)"
                : isLight
                  ? "#fff"
                  : "#0a0a0a",
            color: active === f ? "#fff" : isLight ? "#555" : "#aaa",
            fontWeight: 700,
            fontSize: "clamp(0.75rem,1.5vw,0.88rem)",
            cursor: "pointer",
            transition: "all 0.25s ease",
            fontFamily: "'Outfit',sans-serif",
            boxShadow: active === f ? "0 4px 16px rgba(255,90,0,0.4)" : "none",
          }}
        >
          {f}
        </button>
...
function ProjectCard({
  ...
  const [hov, setHov] = useState(false);
  const gradients = [
    "linear-gradient(135deg,#ff5a00,#ff8800)",
    "linear-gradient(135deg,#ff3a00,#ff6a00,#ffaa00)",
    "linear-gradient(135deg,#ff6a00,#ff9500)",
    "linear-gradient(135deg,#ff4500,#ff7a00)",
    "linear-gradient(135deg,#ff5a00,#ffaa00)",
    "linear-gradient(135deg,#ff3000,#ff6500)",
  ];
          ...
          {tags.map((t, i) => (
            <span
              ...
              style={{
                ...
                fontFamily: "'Fira Code',monospace",
                fontWeight: 600,
                animation: `tagPop 0.4s ease ${0.05 * i}s both`,
              }}
            >
              {t}
            </span>
      ...
      style={{
        ...
        background: hov
          ...
          : primary
            ? "rgba(255,90,0,0.08)"
            : "transparent",
        color: hov ? "#fff" : isLight ? "#cc3a00" : "#ff5a00",
        borderColor: hov ? "transparent" : "#ff5a00",
        transform: hov ? "translateY(-2px)" : "none",
        boxShadow: hov ? "0 6px 18px rgba(255,90,0,0.4)" : "none",
        whiteSpace: "nowrap",
      }}
    >
      {label}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          A selection of things I've built — from web apps to games, each one a
          learning adventure.
        </p>
      </div>
      {visible && (
        <FilterBar active={filter} onChange={setFilter} isLight={isLight} />
      )}
      <div
      ...
      >
        ...
        >
          💼 For professional and secure service, you can also hire me on
          Fiverr.
        </p>
        <a
          href="https://www.fiverr.com/sh_somnath_09"
          target="_blank"
          rel="noreferrer"
          style={{
            display: "inline-flex",
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow =
              "0 12px 30px rgba(29,191,115,0.5)";
          }}
          onMouseLeave={(e) => {
...
const INFO_CARDS = [
  {
    icon: "📧",
    title: "Email",
    value: "somnathhake09@gmail.com",
    link: "mailto:somnathhake09@gmail.com",
  },
  {
    icon: "📱",
    title: "Phone",
    value: "+91 8767 75 0962",
    link: "tel:+918767750962",
  },
  {
    icon: "📍",
    title: "Location",
...
const SOCIALS = [
  ...
  {
    href: "https://github.com/somnathhake09",
    title: "GitHub",
    icon: (
  ...
  {
    href: "https://wa.me/918767750962?text=Hello%20I%20liked%20your%20portfolio.%20Can%20you%20create%20a%20website%20for%20me?",
    title: "WhatsApp",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
  ...
  const inner = (
    <div
      ...
      style={{
        ...
        border: `1px solid ${hov ? "#ff5a00" : "rgba(255,90,0,0.15)"}`,
        boxShadow: hov
          ? "0 18px 50px rgba(255,90,0,0.32)"
          : isLight
            ? "0 6px 24px rgba(0,0,0,0.09)"
            : "0 6px 24px rgba(0,0,0,0.5)",
    ...
    >
      <div
        style={{ fontSize: "clamp(2rem,4vw,2.5rem)", marginBottom: "0.8rem" }}
      >
        {icon}
      </div>
      <h3
...
function FormField({
  ...
  const base = {
    ...
    background: isLight ? "#f0f0f0" : "#060606",
    border: `2px solid ${error ? "#ff3030" : focused ? "#ff5a00" : "rgba(255,90,0,0.2)"}`,
    borderRadius: "10px",
    ...
    transition: "all 0.3s ease",
    outline: "none",
    boxShadow: focused ? "0 0 18px rgba(255,90,0,0.28)" : "none",
    resize: textarea ? "vertical" : undefined,
    minHeight: textarea ? "clamp(120px,18vw,160px)" : undefined,
  };
  return (
    <div style={{ marginBottom: "clamp(1rem,2.5vw,1.5rem)" }}>
      ...
      >
        {label}
        {required && (
          <span style={{ color: "#ff3030", marginLeft: "3px" }}>*</span>
        )}
      </label>
      {textarea ? (
        <textarea
  ...
  return (
    <a
      ...
      style={{
        ...
        textDecoration: "none",
        border: `2px solid ${hov ? "transparent" : "rgba(255,90,0,0.3)"}`,
        boxShadow: hov
          ? "0 12px 35px rgba(255,90,0,0.5)"
          : isLight
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          maxWidth: "1000px",
          margin: "0 auto clamp(2rem,4vw,3rem)",
          animation: visible ? "fadeInUp 0.7s ease 0.35s both" : "none",
          opacity: visible ? undefined : 0,
        }}
      >
        {INFO_CARDS.map((c, i) => (
      ...
      >
        <div
          style={{
            animation: visible ? "fadeInLeft 0.8s ease 0.4s both" : "none",
            opacity: visible ? undefined : 0,
          }}
        >
          <div
    ...
    LinkedIn
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <FormField
                  label="Message"
                  id="message"
                  placeholder="Hello! I'd love to work together on..."
                  value={form.message}
                  onChange={handleChange}
                  required
                  isLight={isLight}
                ...
                <button
                  ...
                  style={{
                    width: "100%",
                    padding: "clamp(0.85rem,2vw,1.1rem) 2rem",
                    background:
                      status === "sending"
                        ? "rgba(255,90,0,0.5)"
                        : "linear-gradient(135deg,#ff5a00,#ff7a00)",
                    ...
                    transition: "all 0.3s ease",
                    boxShadow: "0 8px 25px rgba(255,90,0,0.4)",
                    fontFamily: "'Outfit',sans-serif",
                    animation:
                      status === "sending"
                        ? "sending 1s ease infinite"
                        : "none",
                  }}
                  onMouseEnter={(e) => {
                    if (status !== "sending") {
        ...
        <div
          style={{
            ...
            animation: visible ? "fadeInRight 0.8s ease 0.5s both" : "none",
            opacity: visible ? undefined : 0,
          }}
        >
          <div
            style={{
              ...
              boxShadow: isLight ? "0 4px 18px rgba(0,0,0,0.08)" : "none",
            }}
          >
            <div
              style={{
            ...
            >
              <span
                style={{
                  ...
                  borderRadius: "50%",
                  background: "#22cc66",
                  boxShadow: "0 0 8px #22cc66",
                  display: "inline-block",
                  animation: "sending 1.5s ease infinite",
                }}
              />
              <span
                style={{
          ...
          >
            ...
            {[
              ...
              { ch: "📱", label: "WhatsApp", val: "< 2 hours" },
              { ch: "💼", label: "LinkedIn", val: "< 24 hours" },
            ].map((r) => (
              <div
                key={r.label}
                style={{
          ...
          >
            ...
            {[
              ...
              { label: "See My Skills", href: "#skills", icon: "⚙️" },
            ].map((l) => (
              <a
                key={l.label}
                href={l.href}
                style={{
                  ...
                  fontSize: "0.88rem",
                  transition: "all 0.2s",
                  borderBottom: "1px solid rgba(255,90,0,0.07)",
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.color = "#ff5a00";
              ...
              >
                ...
                {l.label}
                <span
                  style={{ marginLeft: "auto", color: "#ff5a00", opacity: 0.5 }}
                >
                  →
                </span>
              </a>
      ...
      <div
        style={{
          textAlign: "center",
          marginTop: "clamp(2.5rem,5vw,4rem)",
          animation: visible ? "fadeInUp 0.7s ease 0.6s both" : "none",
          opacity: visible ? undefined : 0,
        }}
      >
        <h3
...
const BOT_REPLIES = {
  services:
    "I offer website development, landing pages, portfolio websites, and bug fixing. Let me know what you need! 💻",
  projects:
    "You can check my projects in the Projects section above — each one has a live demo link! 🚀",
  contact:
    "You can reach me via WhatsApp, Email, or LinkedIn from the Contact section below. I usually reply within 24 hours! 📬",
  pricing:
    "My pricing depends on your project requirements. Let's discuss on WhatsApp — I'll give you the best deal! 💬",
};
...
function Chatbot({ isLight }) {
  ...
  const [msgs, setMsgs] = useState([
    {
      from: "bot",
      text: "Hi! I'm Somnath's assistant 👋\nHow can I help you today?",
      whatsapp: true,
    },
  ]);
  ...
  const sendMsg = (text, key) => {
    ...
    setTimeout(() => {
      ...
      const reply = key
        ? BOT_REPLIES[key]
        : "I'm not sure about that. Please use the quick replies or contact Somnath directly! 😊";
  ...
  const handleSend = () => {
    ...
    setInput("");
    const matched = Object.keys(BOT_REPLIES).find((k) =>
    ...
    <>
      {open && (
        ...
        >
          ...
          <div
            style={{
              background: isLight ? "#f9f9f9" : "#0d0d0d",
              height: "300px",
              overflowY: "auto",
              padding: "1rem",
              display: "flex",
                    ...
                    background:
                      m.from === "user"
                        ...
                        : isLight
                          ...
                          : "#1a1a1a",
                    color:
                      m.from === "user" ? "#fff" : isLight ? "#333" : "#eee",
                    fontSize: "0.88rem",
                    lineHeight: 1.5,
                    fontFamily: "'Outfit',sans-serif",
          ...
          >
            {QUICK_REPLIES.map((q) => (
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "rgba(255,90,0,0.15)";
                }}
                onMouseLeave={(e) => {
      ...
      <button
        ...
        style={{
          ...
          alignItems: "center",
          justifyContent: "center",
          boxShadow: "0 6px 24px rgba(255,90,0,0.5)",
          transition: "all 0.3s ease",
...
export default function PortfolioSPA() {
  const [isLight, setIsLight] = useState(() => {
    try {
      ...
      if (v) document.body.className = "light-mode";
      return v;
    } catch {
      return false;
    }
  ...
  const toggleTheme = useCallback(() => {
    setIsLight((v) => {
      ...
      document.body.className = n ? "light-mode" : "";
      return n;
    });
  }, []);
